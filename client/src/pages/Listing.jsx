...
import { FaBath, FaBed, FaParking, FaChair, FaShare } from 'react-icons/fa';
                    ...
                    <Swiper navigation>
                        {listing.imageUrls.map((url) => (
                            <SwiperSlide key={url} className='relative'>
                                ...
                                >
                                    <button 
                                        className='absolute top-4 right-4 bg-white p-2 rounded-full z-10 hover:bg-gray-100'
                                        onClick={handleCopy}
                                    >
                                        <FaShare className='text-slate-500' />
                                    </button>
                                    {copied && (
                                        <span className='absolute top-4 right-16 bg-slate-100 z-10 p-2 rounded-md'>
                                            Link Copied!
                                        </span>
                                    )}
                                </div>
